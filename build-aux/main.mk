...
check: $(tools/ko) $(tools/helm) pkg/install/helm/telepresence-chart.tgz ## (QA) Run the test suite
	...
	TELEPRESENCE_MAX_LOGFILES=300 TELEPRESENCE_LOGIN_DOMAIN=127.0.0.1 go test -v -timeout=29m ./integration_test/... -run='Test_Integration/Test_Namespaces.*/Test_ConflictingProxies'
